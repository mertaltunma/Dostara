...
import 'creat_listing_model.dart';
export 'creat_listing_model.dart';

class CreatListingWidget extends StatefulWidget {
  const CreatListingWidget({super.key});

  @override
  State<CreatListingWidget> createState() => _CreatListingWidgetState();
}

class _CreatListingWidgetState extends State<CreatListingWidget> {
  late CreatListingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreatListingModel());
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Yardım çağrısı veya sahiplendirme ilanı oluşturun',
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  fontFamily: 'Mukta',
                                    ...
                                    Expanded(
                                      child: Align(
                                        ...
                                        child: FlutterFlowChoiceChips(
                                          options: const [
                                            ChipData('Yardım Çağrısı'),
                                            ChipData('Sahiplendirme')
                                          ],
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      await OtherAnnouncementsTable().insert({
                        'created_at':
                            supaSerialize<DateTime>(getCurrentTimestamp),
                        'animal_photo': _model.uploadedFileUrl,
                        'announcement_type': _model.choiceChipsValue,
                        'title': _model.textController1.text,
                        'explanation': _model.textController2.text,
                        'district': _model.textController3.text,
