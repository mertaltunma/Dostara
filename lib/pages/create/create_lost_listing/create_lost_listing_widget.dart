...
import 'create_lost_listing_model.dart';
export 'create_lost_listing_model.dart';

class CreateLostListingWidget extends StatefulWidget {
  const CreateLostListingWidget({super.key});

  @override
  State<CreateLostListingWidget> createState() =>
      _CreateLostListingWidgetState();
}

class _CreateLostListingWidgetState extends State<CreateLostListingWidget> {
  late CreateLostListingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateLostListingModel());
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Kaybolan dostunuz için bir ilan oluşturun',
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  fontFamily: 'Mukta',
                          ...
                          children: [
                            ...
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                hintText:
                                    'Spesifik detaylar, Hayvanın tarifi, Son görüldüğü konum vb.',
                                hintStyle: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      fontFamily: 'Mukta',
                            ...
                            Text(
                              'Uyarı: Yalancı aramaların önüne geçmek için ödül vaadinden kaçının. Para isteyenlere itibar etmeyiniz.',
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      await LostAnimalsPostingsTable().insert({
                        'created_at':
                            supaSerialize<DateTime>(getCurrentTimestamp),
                        'animal_photo': _model.uploadedFileUrl,
                        'animal_name': _model.textController1.text,
                        'district': _model.textController2.text,
                        'city': _model.textController3.text,
                        'explanation': _model.textController4.text,
                        'owner_name': _model.textController5.text,
                        'owner_phone': _model.textController6.text,
                        'owner_email': _model.textController7.text,
